...
(function($) {
    ...
    $.AutoSuggester = function(element, data, options) {
        ...
        plugin.showResults = function(){
            ...
            var inputOffset = plugin.input.offset();
            var resultsOffset = results_container.offset();

            if(resultsOffset.left != inputOffset.left || resultsOffset.top != inputOffset.top+plugin.input.outerHeight()){
                resizeAndReposition();
            }
        }
