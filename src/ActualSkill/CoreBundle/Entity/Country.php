...
/**
 * ActualSkill\CoreBundle\Entity\Country
 *
 * @ORM\Table()
 * @ORM\Entity
 */
class Country
{
     ...
     * Add players
     *
     * @param ActualSkill\CoreBundle\Entity\Player $players
     */
    public function addPlayers(\ActualSkill\CoreBundle\Entity\Player $players)
    {
     ...
     * @param ActualSkill\CoreBundle\Entity\Player $players
     */
    public function addPlayer(\ActualSkill\CoreBundle\Entity\Player $players)
    {
        $this->players[] = $players;
    }
     ...
     * @param ActualSkill\CoreBundle\Entity\Club $clubs
     */
    public function addClub(\ActualSkill\CoreBundle\Entity\Club $clubs)
    {
        $this->clubs[] = $clubs;
    }
}