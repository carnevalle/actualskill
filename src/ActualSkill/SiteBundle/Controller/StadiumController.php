...
use ActualSkill\SiteBundle\Entity\Stadium;
...
class StadiumController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ActualSkillSiteBundle:Stadium')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ActualSkillSiteBundle:Stadium')->find($id);
     ...
     * @Method("post")
     * @Template("ActualSkillSiteBundle:Stadium:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("ActualSkillSiteBundle:Stadium:edit.html.twig")
     */
