...
/**
 * ActualSkill\SharedEntityBundle\Entity\Country
 *
 * @ORM\Table()
 * @ORM\Entity
 */
class Country
{
     ...
     * Add players
     *
     * @param ActualSkill\SharedEntityBundle\Entity\Player $players
     */
    public function addPlayers(\ActualSkill\SharedEntityBundle\Entity\Player $players)
    {
     ...
     * @param ActualSkill\SharedEntityBundle\Entity\Player $players
     */
    public function addPlayer(\ActualSkill\SharedEntityBundle\Entity\Player $players)
    {
        $this->players[] = $players;
    }
     ...
     * @param ActualSkill\SharedEntityBundle\Entity\Club $clubs
     */
    public function addClub(\ActualSkill\SharedEntityBundle\Entity\Club $clubs)
    {
        $this->clubs[] = $clubs;
    }
}