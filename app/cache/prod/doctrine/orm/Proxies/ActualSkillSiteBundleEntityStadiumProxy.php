 ...
 */
class ActualSkillSiteBundleEntityStadiumProxy extends \ActualSkill\SiteBundle\Entity\Stadium implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'slug', 'name', 'ratings', 'comments', 'capacity', 'clubs');
    }
