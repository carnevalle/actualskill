 ...
 */
class ActualSkillSiteBundleEntityPlayerProxy extends \ActualSkill\SiteBundle\Entity\Player implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setObjectTypeOnLoad();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'slug', 'name', 'ratings', 'comments', 'firstname', 'lastname', 'nickname', 'birthday', 'height', 'weight', 'country');
    }
